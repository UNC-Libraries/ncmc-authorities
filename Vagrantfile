...
Vagrant.configure("2") do |config|
  ...
  config.vm.define :centos6_solr_ncmc do |t|
  end
  ...
  config.vm.provider "virtualbox" do |vb|
    # Need more than default for bundle install / building
    # Customize the amount of memory on the VM:
    vb.memory = "1024"
  end
